...
<div id="center">
<form name="pdtreg" action="pdt_reg_proc.pdta" method="post" style="border:1px solid black;" onsubmit="return chkfrm(this);" enctype="multipart/form-data">
	<input type="hidden" name="pi_id" value="<%=pdtInfo.getPi_id() %>" />
	<table width = "800" cellpadding = "5" cellspacing = "0" align = "center">
		<tr>
		<th width = "20%">판매상품관리	</th>
...
-->
		...
		<td>
			<input type="file" name="pp_front" accept="image/*" />
		...
		<td>
			<input type="file" name="pp_back" accept="image/*" />
		...
		<td>
			<input type="file" name="pp_left" accept="image/*" />
		...
		<td>
			<input type="file" name="pp_right" accept="image/*" />
		...
		<td>
			<input type="file" name="pp_bottom" accept="image/*" />
