...
<div id="outer">
	<div id="center">
		...
		<br /><br />
		   ...
		   <tr>
		      <td align = "center"  colspan = "2">
		         <%if(pdtInfo.getPp_etc1() != null && !pdtInfo.getPp_etc1().equals("")) {%>
		         <img src="product/shoePic/<%=pdtInfo.getPp_etc1() %>" width="180" height="200" />
		         <%} %>
		         <%if(pdtInfo.getPp_etc2() != null && !pdtInfo.getPp_etc1().equals("")) {%>
		         <img src="product/shoePic/<%=pdtInfo.getPp_etc2() %>" width="180" height="200" />
		         <%} %>
		         <%if(pdtInfo.getPp_etc3() != null && !pdtInfo.getPp_etc1().equals("")) {%>
		   ...
		   <tr>
		      <td align = "center"  colspan = "2">
		         <%if(pdtInfo.getPp_etc4() != null && !pdtInfo.getPp_etc1().equals("")) {%>
		         <img src="product/shoePic/<%=pdtInfo.getPp_etc4() %>" width="180" height="200" />
		         <%} %>
		         <%if(pdtInfo.getPp_etc5() != null && !pdtInfo.getPp_etc1().equals("")) {%>
		         <img src="product/shoePic/<%=pdtInfo.getPp_etc5() %>" width="180" height="200" />
		         <%} %>
		         <%if(pdtInfo.getPp_etc6() != null && !pdtInfo.getPp_etc1().equals("")) {%>
