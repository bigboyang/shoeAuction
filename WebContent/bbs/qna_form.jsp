...
CenterInfo centerInfo = (CenterInfo)request.getAttribute("centerInfo");

request.setCharacterEncoding("utf-8");
if (loginMember == null) {
	out.println("<script>");
	out.println("alert('먼저 로그인을 해야 합니다.');");
	out.println("location.href = 'login_form.jsp?url=qna_in_form.etc';");	
	out.println("</script>");
	out.close();
}
%>
...
<h2>1:1 문의</h2>
<h3>문의하기</h3>		
<form name="qnaIn" action="qna_in_proc.etc" method="post" enctype="multipart/form-data">
...
<tr>
<td>문의제목 : <input type="text" size="50" name="bq_title"  />
</td>
</tr>
<tr>
<td>문의내용
<br />
<textarea cols="80" rows="10" name="bq_content"  >
</textarea></td>
</tr>
<tr>
<td>파일첨부
<br />
<input type="file" name="bq_img1" /><input type="file" name="bq_img2" />
</td>
</tr>
<tr>
<td>
